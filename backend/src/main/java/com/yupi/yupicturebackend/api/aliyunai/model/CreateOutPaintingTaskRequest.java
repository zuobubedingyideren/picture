...
public class CreateOutPaintingTaskRequest implements Serializable {
    ...
    public static class Parameters implements Serializable {
        /**
         * 可选，上方扩图比例，默认值 1.0，范围 [1.0, 3.0]
         */
        @Alias("top_scale")
        private Float topScale = 1.0f;

        /**
         * 可选，下方扩图比例，默认值 1.0，范围 [1.0, 3.0]
         */
        @Alias("bottom_scale")
        private Float bottomScale = 1.0f;

        /**
         * 可选，左侧扩图比例，默认值 1.0，范围 [1.0, 3.0]
         */
        @Alias("left_scale")
        private Float leftScale = 1.0f;

        /**
         * 可选，右侧扩图比例，默认值 1.0，范围 [1.0, 3.0]
         */
        @Alias("right_scale")
        private Float rightScale = 1.0f;

        /**
         * 可选，生成图像数量，默认值 1，范围 [1, 4]
         */
        private Integer n = 1;

        /**
         * 可选，随机种子，用于控制生成结果的随机性
         */
        private Long seed;
