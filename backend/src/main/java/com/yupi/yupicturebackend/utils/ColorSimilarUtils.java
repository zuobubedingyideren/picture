 ...
 * @description: 工具类：计算颜色相似度，支持多种算法和颜色格式
 */
public class ColorSimilarUtils {
    ...
    /**
     * 根据十六进制颜色代码计算相似度
     * 支持多种十六进制格式：#FFFFFF、FFFFFF、#FFF、FFF等
     *
    ...
    private static void validateRgbValue(int value, String paramName) {
        if (value < 0 || value > 255) {
            throw new IllegalArgumentException(paramName + "必须在0到255之间，当前值: " + value);
        }
    }
