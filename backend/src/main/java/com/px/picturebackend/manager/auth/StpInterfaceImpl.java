...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        // 如果没有 spaceUserId，必然是团队空间，通过数据库查询 SpaceUser 对象
        ...
        // 如果没有 spaceUserId，尝试通过 spaceId 或 pictureId 获取 Space 对象处理
        Long spaceId = authContext.getSpaceId();
        if (spaceId == null) {
            // 如果没有 spaceId，通过 pictureId 获取 Picture 对象并获取 Space 对象
